...
registerRoute(({ url }) => url.origin === scopeUrl.origin && url.pathname === basePath, new NetworkFirst());
registerRoute(({ url }) => url.origin === scopeUrl.origin && url.pathname === basePath + 'privacy-policy/', new NetworkFirst());
registerRoute(({ url }) => url.origin === scopeUrl.origin && url.pathname === basePath + 'reset/', new NetworkOnly());
